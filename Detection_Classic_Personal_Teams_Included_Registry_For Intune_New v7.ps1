...
$AllUsers = Get-ChildItem -Path "$($ENV:SystemDrive)\Users" | Where-Object {
       $_.PSIsContainer -and $_.Name -notlike "Administrator" -and $_.Name -notlike "ITAdmin" -and $_.Name -notlike "IT" -and $_.Name -notlike "Dadmin" -and $_.Name -notlike "Jadmin" -and $_.Name -notlike "Eadmin" -and $_.Name -notlike "Public" -and $_.Name -notlike "Default*"
}
